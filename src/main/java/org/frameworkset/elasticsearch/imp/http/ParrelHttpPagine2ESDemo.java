 ...
 * @version 1.0
 */
public class ParrelHttpPagine2ESDemo {
	private static Logger logger = LoggerFactory.getLogger(ParrelHttpPagine2ESDemo.class);
	public static void main(String[] args){
		...
		httpInputConfig.setDslFile("httpdsl.xml")
				.setQueryDslName("parrelPagineQueryDsl")
